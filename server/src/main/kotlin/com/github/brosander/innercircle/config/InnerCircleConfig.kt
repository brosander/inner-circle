...
data class InnerCircleCliArgumentDefinition(val short: String?, val long: String, val description: String, val default: String?, val required: Boolean?, val hasArg: Boolean = true)
